"""Parameter types for AI Gateway generation endpoints.

Extracted into a standalone module so they can be imported without pulling in
heavy dependencies (``httpx``, etc.) that the adapter functions need.
"""
