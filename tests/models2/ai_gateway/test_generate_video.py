...
from vercel_ai_sdk.models2.ai_gateway import errors
from vercel_ai_sdk.models2.ai_gateway.generate import (
    VideoParams,
    generate,
)
from vercel_ai_sdk.models2.core import client as client_
from vercel_ai_sdk.models2.core import model as model_
...
class TestGenerate:
    ...
    async def test_video_generation_url(self) -> None:
        ...
        with patch(
            "vercel_ai_sdk.models2.core.helpers.media.download",
